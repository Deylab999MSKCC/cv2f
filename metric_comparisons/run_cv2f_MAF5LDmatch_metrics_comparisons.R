...
option_list <- list(
  ...
  make_option("--positive_set_test", type="character", default = "../data/positive_set_validation.txt",
              help="rsIDs of SNPs in the positive set for validation (celltype relevant trait)"),
  make_option("--negative_set_test", type="character", default = "../data/negative_set_validation.txt",
